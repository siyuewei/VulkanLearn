...
execute_process(
  COMMAND "D:/software/code/git/cmd/git.exe" --git-dir=.git show-ref "0.9.9.8"
  WORKING_DIRECTORY "D:/0-wsy/code/VulkanLearn/build/_deps/glm-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/0-wsy/code/VulkanLearn/build/_deps/glm-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/0-wsy/code/VulkanLearn/build/_deps/glm-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
