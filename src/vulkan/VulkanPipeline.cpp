...
namespace VkPipelineUtils
{
    ...
    {
        auto vertShaderCode = VkUtils::readFile(vertShaderPath);
        auto fragShaderCode = VkUtils::readFile(fragShaderPath);
        ...
        auto bindingDescription = VkSceneData::Vertex::getBindingDescription();
        auto attributeDescriptions = VkSceneData::Vertex::getAttributeDescriptions();
